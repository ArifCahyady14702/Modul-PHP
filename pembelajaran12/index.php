...
<body>
	...
	<form action="" method="get">
		<input type="text" name="keyword" autocomplete="off" placeholder="masukan keyword pencarian" size="40">
		<button type="submit" name="cari" style="background-color: aqua; width: 50px;">cari</button>
	</form>
	<br><br>
